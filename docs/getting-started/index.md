...
In case of apps using Vite where Warp components are used inside Shadow DOM, the css generated by the UnoCSS plugin needs to be inlined into the Shadow DOM style. More information on how this is done can be found [here](https://unocss.dev/integrations/vite#shadow-dom).
